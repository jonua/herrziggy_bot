...
public class MessageNotifier {
    ...
    public void notifySubscribers(Message message, Session session) {
        try {
    ...
    private String getTextFromMessage(Message message) throws MessagingException, IOException, MimeTypeParseException {
